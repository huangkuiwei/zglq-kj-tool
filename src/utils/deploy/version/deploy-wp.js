...
// 网页标题
export const webTitle = isOwner ? "数智化管理平台" : "跨~界云空间";
// "KSJ-Space";

const deployFolder = "wp-deploy";
// 登录背景图
export const loginBackgroundImage = require(`/static/deployImage/${deployFolder}/login-bg.jpg`);
// 登录框顶部logo
export const loginFormLogo = require(`/static/deployImage/${deployFolder}/WpBIM.svg`);
// 登录框顶部用标题还是logo
export const loginFormHead = 'title'
// 底部logo
export const loginBottomLogo = require(`/static/deployImage/${deployFolder}/combine-logo.png`);
// 平台界面
// header栏logo
export const headerLogo = require("/static/deployImage/" + deployFolder + "/single1.png");
...
// 主目录显示模块
export const sideBarModules = ["项目空间", "文档资料", "工作台", "团队协作", "公共资源", "系统设置"];
