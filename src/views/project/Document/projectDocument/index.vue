...
<script>
  ...
  export default {
    ...
    methods: {
      getFolderFullPath() {
        return this.$folderFullPath("图档 / 项目文档", this.breadcrumb)
      },
      ...
      handleNodeClick(data) {
        ...
        console.log(this.formData.TargetIUID)
      ...
      async queryData() {
        ...
        var res = await projectFileApi.post("/api/Drawing/GetProjectDocument", formData);
