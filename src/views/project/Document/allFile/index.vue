<template>
  <div class="app-container background table-box">
    ...
    <el-row class="table">
      <el-table class="t-table" :data="tableData" height="100%" :header-cell-style="$thStyle" style="margin-top: 20px; font-size: 13px" stripe @selection-change="handleSelectionChange" :default-sort="{ prop: 'createTime', order: 'descending' }" @sort-change="sortChange"> > <el-table-column type="selection" width="55"> </el-table-column>
        ...
        <el-table-column prop="projectText" label="文件来源" show-overflow-tooltip width="200" :formatter="formatterProject">
        </el-table-column>
        <el-table-column prop="fileSize" :label="$t('base.button.fileSize')" width="120">
        </el-table-column>
        <el-table-column prop="createTime" label="上传时间" sortable="custom" width="200">
        </el-table-column>
        ...
        <el-table-column fixed="right" :label="$t('base.formLabel.operation')">
          <template slot-scope="scope">
